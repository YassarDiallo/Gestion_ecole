...
class Create(PermissionRequiredMixin,CreateView):
    ...
    template_name="eleves/create.html"
    success_url=reverse_lazy('eleves_index')
    permission_required="eleves.add_eleve"
...
class Index(PermissionRequiredMixin,ListView):
    model=Eleve
    template_name="eleves/index.html"
    context_object_name="eleves"
    permission_required="eleves.view_eleve"
...
class Edit(PermissionRequiredMixin,UpdateView):
    model=Eleve
    form_class=EleveForm
    template_name="eleves/edit.html"
    success_url=reverse_lazy('eleves_index')
    permission_required="eleves.change_eleve"
    
    def get_object(self, queryset = None):
        return get_object_or_404(Eleve,slug=self.kwargs.get('slug'))
...
class Delete(PermissionRequiredMixin,DeleteView):
    model=Eleve
    template_name="eleves/delete.html"
    success_url=reverse_lazy('eleves_index')
    permission_required="eleves.delete_eleve"
